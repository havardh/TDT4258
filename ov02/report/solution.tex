...
Calculating this for $f_t = 440 Hz$ gives $pitch\_modificatior \approx 22$. We did try but was not able to verify theese
calculations on the device, due to a poor cell phone microphone.
